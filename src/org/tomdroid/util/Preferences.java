...
public class Preferences {
	...
	public enum Key {
		...
		SYNC_SERVER_SSH_USERNAME("ssh_username", ""),
		SYNC_SERVER_SSH_PASSWORD("ssh_password", ""),
		SYNC_SERVER_SSH_HOST("ssh_hostname", ""),
		SYNC_SERVER_SSH_PORT("ssh_port", "22"),
		SYNC_SERVER_SSH_FODLER("ssh_folder", ""),
		SYNC_SERVER_SSH_PRIVATE_KEY("ssh_private_key", ""),
