...
public class Tomdroid extends ListActivity {
									...
									switch (msg.what) {
											...
											Toast.makeText(
													...
													"Synchronization with "
															+ SyncManager.getInstance()
																	.getCurrentService()
																	.getDescription()
															+ " is complete.", Toast.LENGTH_SHORT)
													.show();
											break;
										...
										case SyncService.PARSING_FAILED:
											if (Tomdroid.LOGGING_ENABLED)
												Log
														.w(TAG,
																"handler called with a parsing failed message");
	...
	private void handleSyncProgress(Message msg) {
		...
		if (msg.arg1 < 20) msg.arg1 = 20;

		if (msg.arg2 < 20) msg.arg2 = 20;
		
		ScaleAnimation scaling = 
			new ScaleAnimation(msg.arg2 / 100f, msg.arg1 / 100f, msg.arg2 / 100f, msg.arg1 / 100f,
