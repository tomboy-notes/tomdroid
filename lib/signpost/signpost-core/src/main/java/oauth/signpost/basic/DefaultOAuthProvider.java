...
public class DefaultOAuthProvider implements OAuthProvider {
	...
	private transient HttpGet connection;
	...
	protected void retrieveToken(String endpointUrl)
		...
		try {
			if (connection == null) {
				connection = new HttpGet(endpointUrl);
			}
			
			for (String header : defaultHeaders.keySet()) {
				connection.setHeader(header, defaultHeaders.get(header));
			}
	...
	void setHttpUrlConnection(HttpGet connection) {
